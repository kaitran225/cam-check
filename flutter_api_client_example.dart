...
class CamCheckApiClient {
  static const String _baseUrl = 'https://api.camcheck.com'; // Replace with your API URL
  ...
  // Singleton pattern
  static final CamCheckApiClient _instance = CamCheckApiClient._internal();
  factory CamCheckApiClient() => _instance;
  CamCheckApiClient._internal();
  ...
  Future<bool> _refreshTokenIfNeeded() async {
    ...
    try {
      final response = await _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/auth/refresh'),
  ...
  Future<bool> login(String username, String password) async {
    try {
      ...
      final response = await _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/auth/login'),
        headers: {'Content-Type': 'application/json'},
        body: json.encode({
          'username': username,
          'password': password,
  ...
  Future<bool> logout() async {
    ...
    try {
      await _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/auth/logout'),
      ...
      if (_deviceId != null) {
        try {
          await _client.delete(
            Uri.parse('$_baseUrl/api/$_apiVersion/devices/$_deviceId'),
            headers: _createAuthHeaders(),
          );
        } catch (e) {
  ...
  Future<bool> _registerDevice() async {
    ...
    try {
      ...
      await _authenticatedRequest(() => _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/devices/register'),
        headers: _createAuthHeaders(),
        body: json.encode({
          'deviceId': _deviceId,
          'deviceName': deviceDetails['deviceName'],
  ...
  Future<bool> updateFcmToken(String fcmToken) async {
    ...
    try {
      await _authenticatedRequest(() => _client.put(
        Uri.parse('$_baseUrl/api/$_apiVersion/devices/$_deviceId/fcm-token'),
        headers: _createAuthHeaders(),
        body: json.encode({
          'fcmToken': fcmToken,
        }),
  ...
  Future<Map<String, dynamic>> getMobileConfig() async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.get(
        Uri.parse('$_baseUrl/api/$_apiVersion/config'),
        headers: _createAuthHeaders(),
      ));
  ...
  Future<Map<String, dynamic>> updatePreferences(Map<String, dynamic> preferences) async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/config/preferences'),
        headers: _createAuthHeaders(),
  ...
  Future<Map<String, dynamic>> getQualityOptions() async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.get(
        Uri.parse('$_baseUrl/api/$_apiVersion/config/quality-options'),
        headers: _createAuthHeaders(),
      ));
  ...
  Future<Map<String, dynamic>> createSession({
    ...
    try {
      final responseBody = await _authenticatedRequest(() => _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/sessions'),
        headers: _createAuthHeaders(),
        body: json.encode({
  ...
  Future<Map<String, dynamic>> joinSession(
    ...
    try {
      final responseBody = await _authenticatedRequest(() => _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/sessions/$sessionCode/join'),
        headers: _createAuthHeaders(),
        body: json.encode({
  ...
  Future<bool> endSession(String sessionCode) async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.delete(
        Uri.parse('$_baseUrl/api/$_apiVersion/sessions/$sessionCode'),
        headers: _createAuthHeaders(),
      ));
  ...
  Future<Map<String, dynamic>> getWebRTCConfig() async {
    try {
      ...
      final responseBody = await _authenticatedRequest(() => _client.get(
        Uri.parse('$_baseUrl/api/$_apiVersion/webrtc/config?networkType=$networkType&batteryLevel=$batteryLevel&deviceType=$deviceType'),
        headers: _createAuthHeaders(),
      ));
  ...
  Future<Map<String, dynamic>> initializeWebRTCConnection(
    ...
    try {
      ...
      final responseBody = await _authenticatedRequest(() => _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/webrtc/connect/$receiverId'),
        headers: _createAuthHeaders(),
        body: json.encode({
          'quality': quality,
          'audioEnabled': audioEnabled,
  ...
  Future<bool> sendIceCandidates(String connectionId, Map<String, dynamic> candidates) async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/webrtc/candidates/$connectionId'),
        headers: _createAuthHeaders(),
  ...
  Future<bool> sendSessionDescription(String connectionId, Map<String, dynamic> sdp) async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.post(
        Uri.parse('$_baseUrl/api/$_apiVersion/webrtc/sdp/$connectionId'),
        headers: _createAuthHeaders(),
  ...
  Future<Map<String, dynamic>> getConnectionStatus(String connectionId) async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.get(
        Uri.parse('$_baseUrl/api/$_apiVersion/webrtc/status/$connectionId'),
        headers: _createAuthHeaders(),
      ));
      ...
      throw ApiException(500, 'Failed to get connection status', null);
    } catch (e) {
  ...
  Future<bool> endWebRTCConnection(String connectionId) async {
    try {
      final responseBody = await _authenticatedRequest(() => _client.delete(
        Uri.parse('$_baseUrl/api/$_apiVersion/webrtc/$connectionId'),
        headers: _createAuthHeaders(),
      ));
