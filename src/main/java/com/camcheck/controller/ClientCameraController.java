...
public class ClientCameraController {
    ...
    @ResponseBody
    public ApiResponse handleAudioData(@RequestBody Map<String, String> payload) {
        try {
            ...
            // Process audio data (will be used by WebSocket service)
            log.debug("Received audio data: {} bytes", audioBytes.length);
            
            return ApiResponse.success("Audio data received", Map.of(
